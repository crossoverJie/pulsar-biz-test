 ...
 */
@Slf4j
public class DelayTest extends AbstractJobDefine {

    public DelayTest(Event event, String jobName, PulsarClient pulsarClient, int timeout) {
    ...
    public void run(PulsarClient pulsarClient, PulsarAdmin admin) throws Exception {
        ...
        for (int i = 0; i < number; i++) {
            ...
            MessageId send = producer.newMessage()
                    .deliverAfter(i, TimeUnit.SECONDS)
                    .value(msg.getBytes())
                    .send();
